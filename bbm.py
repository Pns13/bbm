...
def menu(my_name,my_id):
	...
	print(f'{m}★  {k}★  {h}★  {u}★  {b}★    {m}★  {k}★  {h}★  {u}★  {b}★  {m}★  {k}★  {h}★  {u}★  {b}★  {m}★  {k}★  {h}★  {u}★  {b}★\n{h}Selamat Datang{u} %s {k}SI ANAK HARAM'%(my_name)) 
	...
	print(f'{u}[1] Crack Publik     {k}★     {u}[2] Crack Follower\n{u}[3] Crack Grup     {k}  ♥     {u}[4] Crack File\n{u}[5] Hasil Crack     {k} ♥     {u}[0] Keluar\n{m}★ {k}•{h}•{b}•{u}•{m}•{k}•{h}•{u}•{h} ★ {k}•{h}•{b}•{u}•{m}•{k}•{h}•{u}•{u} ★ {k}•{h}•{b}•{u}•{m}•{k}•{h}•{u}• {k} ★ {k}•{h}•{b}•{u}•{m}•{k}•{h}•{u}• {b} ★') 
...
if __name__=='__main__':
	...
	popen_xd(f'\n\t{k}[+] {m}WELLCOME TO MY SCRIPT.... \n\t{k}[+] {k}HARAP GUNAKAN DENGAN BIJAK\n\t{k}[+] {h}INI SCRIPT FREE \n\t{k}[+] {u}TIDAK UNTUK DIPERJUAL BELIKAN \n\t{k}[+] {h}INFO LANJUT......... \n\t{k}[+] {m}FB :ʬʬ-ʚïɞ POPEN NOPRIANSYAH ʚïɞ-ʬʬ\n\t{k}[+] {u}WA : 082311023880\n\t{k}[+] I AM  FROM BENGKULU\n\t{k}[+] {h}SEE YOU') 
	time.sleep(5)
	login()
